...
ConcreteIterator和ConcreteAggregate中各自引用了互相的接口，ConcreteIterator中的Aggregate接口用于遍历等操作，ConcreteAggregate中的Iterator用于创建一个ConcreteIterator的操作。



### 十七、单例模式

> 保证一个类仅由一个实例，并提供一个访问它的全局访问点
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9aak4neu8j30ww0u0qgp.jpg)

![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9aak9rqf4j30zw0cen3b.jpg)
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9ab5jjk0sj314s0osdrl.jpg)
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9ab7os2tnj30vi0g4dnk.jpg)
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9aboqros1j30ye0ii18g.jpg)

#### 优点

- 减少了各个Colleague之间的耦合，使得可以独立地改变和复用各个Colleague类和Mediator。
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9acyb37saj30ze0jstkz.jpg)
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9afvwfxv7j312a0mmh0g.jpg)

#### 使用场景

- 当有一个语言需要解释器执行，并且你可将该语言中的句子表示为一个抽象语法树时，可以使用解释器
...
![](https://tva1.sinaimg.cn/large/006y8mN6gy1g9ag40or2lj30u00u8au9.jpg)

#### 特点

- 把数据结构和作用于数据结构上操作的耦合解开，是的操作集合可以相对自由的演化

#### 优缺点

- 访问者模式适用于数据结构相对稳定的系统，增加新的操作很容易，但增加新的数据结构很困难
